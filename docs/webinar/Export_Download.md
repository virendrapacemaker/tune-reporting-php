...
&fields=id,created,site_id,site.name,publisher_id,publisher.name,is_unique,advertiser_sub_campaign_id,advertiser_sub_campaign.ref,publisher_sub_campaign_id,publisher_sub_campaign.ref
&format=csv
&api_key=API_KEY
```
